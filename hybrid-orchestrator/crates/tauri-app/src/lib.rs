...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::set_web_search_provider,
            commands::get_web_search_config,
            commands::clear_web_search_provider,
            commands::run_web_search,
            commands::add_network_peer,
            commands::list_network_peers,
            commands::remove_network_peer,
            commands::set_model_sharing,
            commands::get_model_sharing,
            commands::discover_network_peers,
